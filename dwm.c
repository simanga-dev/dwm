...
/* enums */
/* <<<<<<< HEAD */
/* enum { CurNormal, CurResize, CurMove, CurLast }; /1* cursor *1/ */
/* enum { SchemeNorm, SchemeSel, SchemeTitle }; /1* color schemes *1/ */
/* ||||||| 0dbc0e5 */
/* enum { CurNormal, CurResize, CurMove, CurLast }; /1* cursor *1/ */
/* enum { SchemeNorm, SchemeSel }; /1* color schemes *1/ */
/* ======= */
enum { CurNormal, CurResize, CurMove, CurSwal, CurLast, SchemeTitle }; /* cursor */
